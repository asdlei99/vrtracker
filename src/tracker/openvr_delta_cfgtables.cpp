...
const app_property_row application_uint64_properties_table[] =
{
	EXPANDO_APP_PROPERTY_UINT64O(LastLaunchTime)
};

#define EXPANDO_APP_PROPERTY_BOOLO(x) { vr::VRApplicationProperty_ ## x ## _Bool, #x }
const app_property_row application_bool_properties_table[] =
{
...
const app_property_row application_string_properties_table[] =
{
...
static const int defs_tbl_size = sizeof(section_defs) / sizeof(section_defs[0]);
